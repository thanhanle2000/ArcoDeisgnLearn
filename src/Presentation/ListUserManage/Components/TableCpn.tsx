...
function TableCpn({
    ...
    // STATE
    const [elementHeights, setElementHeights] =
        useState<ElementHeightInterface>({
            breadcrumbHeight: 0,
            headerHeight: 0,
            tableFilterHeight: 0,
    ...
    const getHeights = useCallback(() => {
        ...
        if (
            ...
            const tablePaginationMargin = {
                top:
                    parseInt(getComputedStyle(tablePagination).marginTop, 10) ||
                    0,
                bottom:
                    parseInt(
                        getComputedStyle(tablePagination).marginBottom,
                        10
                    ) || 0,
            };
            ...
            const breadcrumbMargin = {
                ...
                bottom:
                    parseInt(getComputedStyle(breadcrumb).marginBottom, 10) ||
                    0,
            };
            ...
            const tableFilterMargin = {
                ...
                bottom:
                    parseInt(getComputedStyle(tableFilter).marginBottom, 10) ||
                    0,
            };

            const layoutHeaderMargin = {
                top:
                    parseInt(getComputedStyle(layoutHeader).marginTop, 10) || 0,
                bottom:
                    parseInt(getComputedStyle(layoutHeader).marginBottom, 10) ||
                    0,
            };
