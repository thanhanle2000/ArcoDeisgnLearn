...
function db<T>(table: string) {
    ...
    return {
        ...
        getById(_columnId: string) {
            return {} as T;
        },
        removeById(_columnId: string) {
            return false;
        },
        create<T>(_params: T) {},
        // update(id: string, newModel: Todo): Promise<Todo>
        updateByField(_columnId: string, _field: any, _newValue: any) {
            return {} as T;
        },
    };
}
